...
const Contact = () => {
  ...
  return (
    <main id="contact" className="">
      <section>
      <div className="bg-white bg-opacity-50 rounded-xl px-6 py-2 sm:py-4 lg:px-8">
      ...
      <form action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20">
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          ...
          <div className="sm:col-span-2">
            ...
            <p className="mt-3 text-sm leading-6 text-gray-600">Write a few sentences about you would like us to do.</p>
          </div>
